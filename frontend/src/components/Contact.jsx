...
export default function Contact({
  ...
  return (
    <section
      id="contact"
      data-scroll-target="assessment-form"
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-[#94A3B8] leading-relaxed max-w-md">
              Talk to our SIRA-certified engineers. We respond
          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[#94A3B8] text-sm">
                Share a few details and we&apos;ll get back to
                you promptly.
              </p>
              ...
              <div className="mt-7 grid md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center h-12 rounded-md border border-[#1E2235] bg-[#05050A] overflow-hidden focus-within:ring-1 focus-within:ring-[#0055FF]">
                    <div className="px-4 h-full flex items-center border-r border-[#1E2235] text-white font-medium">
                      +971
                    </div>
                    ...
                    <input
                      ...
                      className="flex-1 h-full bg-transparent px-4 text-white placeholder:text-[#64748b] outline-none"
                    />
                  </div>
                </div>
              </div>
